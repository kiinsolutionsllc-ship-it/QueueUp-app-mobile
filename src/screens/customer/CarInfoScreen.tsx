...
export default function CarInfoScreen({ navigation, route }: CarInfoScreenProps) {
  ...
  const getBodyStyles = (make, model) => {
    ...
    if (bodyStylePatterns[make] && bodyStylePatterns[make][model]) {
      return bodyStylePatterns[make][model];
    }
  ...
  const getDrivetrains = (make, model, year) => {
    // Test with Honda CR-V to verify the system works
    if (make === 'Honda' && model === 'CR-V') {
    ...
    if (drivetrainPatterns[make] && drivetrainPatterns[make][model]) {
      return drivetrainPatterns[make][model];
    }
  ...
  const getEngineTypes = (make, model, year) => {
    ...
    if (engineTypePatterns[make] && engineTypePatterns[make][model]) {
      return engineTypePatterns[make][model];
    }
  ...
  const getTransmissions = (make, model, year) => {
    // Test with Honda CR-V to verify the system works
    if (make === 'Honda' && model === 'CR-V') {
    ...
    if (transmissionPatterns[make] && transmissionPatterns[make][model]) {
      return transmissionPatterns[make][model];
    }
  ...
  const getFuelTypes = (make, model, year) => {
    // Test with Honda CR-V to verify the system works
    if (make === 'Honda' && model === 'CR-V') {
    ...
    if (fuelTypePatterns[make] && fuelTypePatterns[make][model]) {
      return fuelTypePatterns[make][model];
    }
