...
class UniqueIdGenerator {
  ...
  // User ID generation methods removed - now using Supabase UUIDs
  // generateUserId(), generateCustomerId(), and generateMechanicId() are deprecated
  // User IDs are now generated by Supabase auth.users table as UUIDs
